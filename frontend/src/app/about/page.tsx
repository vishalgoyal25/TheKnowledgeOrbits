        ...
        <div className="flex flex-col min-h-screen bg-white">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-8">
                            ...
                            <p className="text-lg text-slate-600 leading-relaxed">
                                In a world of information overload, conventional coaching often leaves aspirants drowning in generic PDFs. We believe in <strong>Precision Learning</strong>.
                            </p>
                            <div className="space-y-6">
                                <div className="flex gap-4 p-5 rounded-2xl bg-blue-50 border border-blue-100">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-900 mb-1">Retrieval Augmented Generation (RAG)</h4>
                                        <p className="text-sm text-slate-600">Our proprietary AI doesn't just guess. It retrieves data from verified NCERT, Yojna, and Standard textbooks before generating your study material.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-2xl bg-emerald-50 border border-emerald-100">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-900 mb-1">Instant Syllabus Mapping</h4>
                                        <p className="text-sm text-slate-600">Every word you read on our platform is tagged to a specific UPSC Syllabus pillar. No more "general" studies; only "targeted" excellence.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative">
                            <div className="aspect-square rounded-3xl bg-slate-100 p-8 flex items-center justify-center overflow-hidden border border-slate-200">
                                <div className="relative z-10 text-center space-y-6">
                                    ...
                                    <h3 className="text-2xl font-black text-slate-900">Your Private <br /> Knowledge Cloud</h3>
                                    <p className="text-slate-500 font-medium">Synced across all your devices.</p>
                                </div>
                                {/* Decorative Elements */}
            ...
            <section className="py-24 bg-slate-50 border-y border-slate-100">
                <div className="container mx-auto px-4 text-center mb-16">
                    <Badge className="bg-blue-100 text-blue-600 border-none mb-4">OUR FOUNDATIONS</Badge>
                    <h2 className="text-4xl font-extrabold text-slate-900">Built on Three Orbits</h2>
                </div>
                ...
                <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div key={i} className="p-8 bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl transition-all hover:-translate-y-2">
                            <div className={`h-14 w-14 ${pillar.bg} rounded-2xl flex items-center justify-center mb-6`}>
                                <pillar.icon className={`h-7 w-7 ${pillar.color}`} />
                            </div>
                            <h3 className="text-xl font-black text-slate-900 mb-4">{pillar.title}</h3>
                            <p className="text-slate-600 leading-relaxed font-medium text-sm">{pillar.desc}</p>
                        </div>
                    ))}
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 text-center">
                    <div className="max-w-2xl mx-auto space-y-8">
                        ...
                        <p className="text-lg text-slate-600 font-medium leading-relaxed">
                            We envision a world where the daughter of a farmer in a remote village has the same quality of UPSC mentoring as someone in Old Rajinder Nagar. AI makes this equality possible.
                        </p>
                        <div className="pt-8">
                            <Link href="/auth/register">
                                <Button size="lg" className="h-16 px-10 text-lg bg-blue-600 hover:bg-blue-700 gap-3 group">
                                    Be Part of the Revolution <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
                                </Button>
                            </Link>
                        </div>
                    </div>
            ...
            <section className="py-16 bg-slate-900 border-t border-white/5">
                <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-2xl font-bold text-white tracking-tighter">TheKnowledgeOrbits</span>
                    </div>
                    <p className="text-slate-400 text-sm font-medium">© 2026 AI-Powered UPSC Ecosystem. Built for the brilliant.</p>
                </div>
            </section>
        </div>
    );
