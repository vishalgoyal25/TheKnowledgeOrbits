...
export default async function ArticlesPage() {
  try {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mt-12 pt-4 border-t border-gray-100 flex justify-between items-center text-[10px] text-gray-400 uppercase tracking-widest font-bold">
          <div className="flex items-center gap-2">
            ...
            {initialArticles.length > 0
              ? "Live Sync Active (1h)"
              : "Standby Mode: Waiting for Backend"}
          </div>
    ...
    console.warn(
      "ISR Fetch Failed for Articles (Likely Render 503). Falling back to Client-side fetch.",
      error,
    );
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <ArticlesClient initialArticles={[]} initialTotal={0} />
      </div>
    );
  }
}
