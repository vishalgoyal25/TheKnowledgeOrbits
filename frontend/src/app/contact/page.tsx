        ...
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <section className="pt-24 pb-16 bg-gradient-to-b from-slate-50 to-white border-b">
                <div className="container mx-auto px-4 text-center">
                    <Badge className="mb-6 px-4 py-1.5 bg-blue-100 text-blue-600 border-blue-200">CONTACT OUR TEAM</Badge>
                    <h1 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-6">
                        Let's Orbit <span className="text-blue-600 font-serif">Together</span>
                    </h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                        ...
                        <div className="space-y-6">
                            <div className="p-8 rounded-3xl bg-blue-50 border border-blue-100 space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600 font-medium">support@knowledgeorbits.com</p>
                                </div>
                            </div>
                            ...
                            <div className="p-8 rounded-3xl bg-emerald-50 border border-emerald-100 space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600 font-medium">Digital First Platform, <br />New Delhi, India</p>
                                </div>
                            </div>
                            ...
                            <div className="p-8 rounded-3xl bg-slate-900 text-white space-y-6">
                                ...
                                <div className="flex gap-4">
                                    <a href="#" className="h-10 w-10 bg-white/10 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-colors">
                                        <Twitter className="h-5 w-5" />
                                    </a>
                                    <a href="#" className="h-10 w-10 bg-white/10 rounded-xl flex items-center justify-center hover:bg-slate-700 transition-colors">
                                        <Github className="h-5 w-5" />
                                    </a>
                                    <a href="#" className="h-10 w-10 bg-white/10 rounded-xl flex items-center justify-center hover:bg-blue-700 transition-colors">
                        ...
                        <div className="lg:col-span-2 p-10 rounded-3xl border border-slate-100 bg-white shadow-2xl shadow-slate-100">
                            <div className="flex items-center gap-3 mb-8">
                                ...
                                <h2 className="text-3xl font-black text-slate-900">Send a Quick Message</h2>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-sm font-bold text-slate-700 ml-1">Institution/Batch</label>
                                        <Input
            ...
            <section className="py-24 bg-slate-50 border-t">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <h2 className="text-2xl font-black text-slate-900 mb-4">A Global Community of Learners</h2>
                    <p className="text-slate-500 font-medium max-w-lg mx-auto">
                        Our servers are distributed across the globe to ensure your orbits load instantly, no matter where you are.
                    </p>
                </div>
            </section>
        </div>
