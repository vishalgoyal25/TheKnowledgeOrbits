  ...
  recent_activity: [
    {
      ...
      event_data: { title: "Mauryan Empire" },
      created_at: new Date().toISOString(),
    },
    {
      event_type: "quiz_completed",
      event_data: { title: "Polity Basics", score: 90 },
  ...
  insights: [
    {
      type: "strength",
      data: {
        message: "You are performing exceptionally well in Ancient History!",
      },
      generated_at: new Date().toISOString(),
    },
    {
      type: "warning",
      data: { message: "Your streak is at risk! Read one article today." },
      generated_at: new Date().toISOString(),
    },
  ],
};
      ...
      <div className="p-8 text-center max-w-md mx-auto mt-20">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6">
          ...
          <p className="text-red-600 mb-4">
            We couldn't fetch your learning data right now.
          </p>
          <Button
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-6 text-white shadow-lg flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="space-y-2">
              ...
              <p className="text-blue-100 max-w-lg">
                ...
                <span className="font-bold underline">preview</span> of the
                dashboard. Sign up now to track your actual syllabus coverage,
                get AI-powered insights, and ace the UPSC exam!
              </p>
            </div>
            <div className="flex gap-4">
              ...
              <Link href="/auth/login">
                <Button
                  variant="outline"
                  className="border-white text-white bg-blue-600/20 hover:bg-white hover:text-blue-600 transition-all font-semibold"
                >
                  Sign In
                </Button>
              </Link>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              {isAuthenticated
                ? "Track your progress and orbits of knowledge."
        ...
        <section className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link href="/generate">
              <Button
                variant="outline"
                className="w-full h-32 flex-col gap-2 hover:bg-blue-50 hover:border-blue-200 transition-all group"
                size="lg"
              >
            ...
            <Link href="/topics">
              <Button
                variant="outline"
                className="w-full h-32 flex-col gap-2 hover:bg-green-50 hover:border-green-200 transition-all group"
                size="lg"
              >
            ...
            <Link href="/articles">
              <Button
                variant="outline"
                className="w-full h-32 flex-col gap-2 hover:bg-purple-50 hover:border-purple-200 transition-all group"
                size="lg"
              >
            ...
            <Link href="/assessment">
              <Button
                variant="outline"
                className="w-full h-32 flex-col gap-2 hover:bg-red-50 hover:border-red-200 transition-all group"
                size="lg"
              >
