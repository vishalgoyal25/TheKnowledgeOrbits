...
export function useDocumentAsArticle(documentId: string, chunkIndexStr?: string | null, options?: { enabled?: boolean }) {
    ...
    return useQuery({
        ...
        queryFn: async (): Promise<Article> => {
            ...
            const docRes = await apiClient.get<DocumentResponse>(`/content/documents/${documentId}/`);
