...
export const topicsAPI = {
  ...
  listByModule: async (moduleId: string, params?: PaginationParams): Promise<TopicListResponse> => {
  ...
  listBySubject: async (subjectId: string, params?: PaginationParams): Promise<TopicListResponse> => {
    const response = await apiClient.get('/knowledge/topics/', {
