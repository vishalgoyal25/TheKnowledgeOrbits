...
import { formatRelativeTime, getQualityColor, getReviewStatusColor } from '@/lib/utils';
            ...
            <Card className="h-full transition-all hover:shadow-lg hover:scale-[1.02]">
                <CardHeader>
                    <div className="flex items-start justify-between gap-2">
                        ...
                        <Badge variant="secondary" className={getReviewStatusColor(article.review_status)}>
