...
const MOCK_ATTEMPTS: any[] = [
    {
        id: 'mock-1',
        quiz: { id: 'mock-q1', title: 'Indian Polity: Preamble', topic: { name: 'Polity' }, question_count: 10 },
        status: 'submitted',
        score: 80,
    ...
    {
        id: 'mock-2',
        quiz: { id: 'mock-q2', title: 'Modern History: Gandhian Era', topic: { name: 'History' }, question_count: 15 },
        status: 'active',
        score: null,
...
export default function RecentQuizzes({ isGuest = false }: RecentQuizzesProps) {
    ...
    const { data: attempts, isLoading } = useMyAttempts(undefined, { enabled: !isGuest });
