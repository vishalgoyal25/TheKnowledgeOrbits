            ...
            case 'article_read':
                return (
                    <p className="text-sm text-gray-700">
                        Read <span className="font-semibold">{activity.event_data.title}</span>
                    </p>
                );
            case 'quiz_completed':
                return (
                    <p className="text-sm text-gray-700">
                        Completed <span className="font-semibold">{activity.event_data.title}</span> with score <span className="font-bold">{activity.event_data.score}%</span>
                    </p>
                );
            default:
