...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Redis-cache%20%C2%B7%20SSE-DC382D?logo=redis&logoColor=white" alt="Redis">
  <img src="https://img.shields.io/badge/Supabase-Postgres-3FCF8E?logo=supabase&logoColor=white" alt="Supabase">
  <img src="https://img.shields.io/badge/Upstash-Redis-00E9A3?logo=upstash&logoColor=white" alt="Upstash"><br>
  <sub><b>🧠 AI / ML / LLMOps</b></sub><br>
  <img src="https://img.shields.io/badge/Groq-LLM-F55036" alt="Groq">
  <img src="https://img.shields.io/badge/Cerebras-LLM-FF6B00" alt="Cerebras">
  <img src="https://img.shields.io/badge/Hugging%20Face-embeddings-FFD21E?logo=huggingface&logoColor=black" alt="Hugging Face">
  <img src="https://img.shields.io/badge/sentence--transformers-MiniLM-EE4C2C" alt="sentence-transformers">
  <img src="https://img.shields.io/badge/LangGraph-agentic-1C3C3C?logo=langchain&logoColor=white" alt="LangGraph">
  <img src="https://img.shields.io/badge/Pydantic-v2-E92063?logo=pydantic&logoColor=white" alt="Pydantic v2">
  <img src="https://img.shields.io/badge/Tavily-search-3B82F6" alt="Tavily">
  <img src="https://img.shields.io/badge/Exa-search-1D4ED8" alt="Exa">
  <img src="https://img.shields.io/badge/Langfuse-tracing-0A0A0A" alt="Langfuse">
  <img src="https://img.shields.io/badge/DeepEval-judge-8B5CF6" alt="DeepEval"><br>
  ...
  <img src="https://img.shields.io/badge/React%20Flow-@xyflow-FF0072" alt="React Flow">
  <img src="https://img.shields.io/badge/Jest-tests-C21325?logo=jest&logoColor=white" alt="Jest"><br>
  <sub><b>☁️ Infrastructure &amp; DevOps</b></sub><br>
  ...
  <img src="https://img.shields.io/badge/Brevo-SMTP-0B996E?logo=brevo&logoColor=white" alt="Brevo">
  ...
  <img src="https://img.shields.io/badge/Docker-CI%20builds-2496ED?logo=docker&logoColor=white" alt="Docker">
  <img src="https://img.shields.io/badge/Codecov-coverage-F01F7A?logo=codecov&logoColor=white" alt="Codecov"><br>
  <img src="https://img.shields.io/badge/License-Proprietary-red" alt="License">
</p>

<!-- Screenshot: landing / home page. Save as assets/screenshots/hero.png -->
<p align="center">
  <img src="assets/screenshots/hero.png" alt="TheKnowledgeOrbits — home" width="100%">
</p>
...
- [Overview](#-overview)
  - [System at a Glance](#️-system-at-a-glance)
  - [Core Design Principles](#-core-design-principles)
- [Key Features](#-key-features)
- [Screenshots](#-screenshots)
- [Architecture](#️-architecture)
  - [The RAG Pipeline (the core)](#-the-rag-pipeline-the-core)
  - [One Gateway, Many Consumers](#one-gateway-many-consumers)
  - [Technology Stack](#technology-stack)
  - [Engine Overview](#engine-overview)
- [Architecture Deep-Dives](#-architecture-deep-dives)
  - [Daily Current-Affairs Pipeline](#-daily-current-affairs-pipeline-fully-automated)
  - [Request Lifecycle & Deployment Topology](#-request-lifecycle--deployment-topology)
  - [Authentication, Email Verification & RBAC Flow](#-authentication-email-verification--rbac-flow)
  - [Testing & CI/CD](#-testing--cicd--local--github-actions--render)
  - [Data Model — Knowledge Hierarchy & RAG Spine](#️-data-model--knowledge-hierarchy--rag-spine)
...
- [LLMOps & AgentOps — Operating the Agent](#-llmops--agentops--operating-the-agent)
  ...
  - [Session Lifecycle & Orchestration](#-agentops--session-lifecycle--orchestration)
  - [Live Streaming, Cancellation & Guardrails](#-agentops--live-streaming-cancellation--guardrails)
...
<!--
  Add your screenshots to assets/screenshots/ using these exact filenames:
    daily-current-affairs.png · research-agent.png · daily-quiz.png · knowledge_map.png
  PNG or JPG, ~1200px wide renders best. Broken-image icons below are normal until the files are added.
-->

|                 📰 AI-generated Daily Current Affairs                  |        🤖 Agentic Research Assistant (live SSE + React Flow)         |
| :--------------------------------------------------------------------: | :------------------------------------------------------------------: |
| ![Daily Current Affairs](assets/screenshots/daily-current-affairs.png) | ![Agentic Research Assistant](assets/screenshots/research-agent.png) |
|                       **🧠 Auto-generated Quiz**                       |                   **🗺️ Interactive Knowledge Map**                   |
|            ![Daily Quiz](assets/screenshots/daily-quiz.png)            |        ![Knowledge Map](assets/screenshots/knowledge_map.png)        |

> 📄 **Full generated output:** [read a complete sample report produced by the Research Agent (PDF) →](assets/research-agent-sample-report.pdf)

---

## 🏗️ Architecture

### 🔎 The RAG Pipeline (the core)

Every content generator (daily articles, quizzes, theory) calls through a single shared grounding
gateway — no free-form LLM generation. Retrieval is hybrid, fused, and relevance-gated:
...
#### One Gateway, Many Consumers

The real architectural bet: **a single `retrieve_grounding()` gateway grounds every generator on the
platform.** Four independent content pipelines call the _same_ hybrid-retrieval pool, get back the
_same_ `GroundingResult` shape, and adapt it into their own prompt slots — Wikipedia is a fallback
...
<details>
<summary><b>📦 Expand the 15-engine catalog</b></summary>
...
### 📰 Daily Current-Affairs Pipeline (fully automated)

Zero manual intervention: news is ingested on a schedule, then a nightly worker scores, auto-approves,
generates, and publishes — 10 daily articles + 1 public quiz, every day.
...
### 🌐 Request Lifecycle &amp; Deployment Topology

How a request travels edge → Render → database, and how a deploy ships safely (migrations on the
direct port, blue-green swap).
...
### 🔐 Authentication, Email Verification &amp; RBAC Flow
...
### 🧪 Testing &amp; CI/CD — Local → GitHub Actions → Render
...
### 🗂️ Data Model — Knowledge Hierarchy &amp; RAG Spine
...
(Gemini is wired but out of rotation). A caller states a _preference_; the pool guarantees an
_answer_ as long as one provider is alive — the agent never sees the failover.
...
## 🔭 LLMOps &amp; AgentOps — Operating the Agent

Building an agent is one thing; _operating_ it in production is another. **LLMOps** covers the model
layer — tracing, prompt versions, cost/rate control, and output-quality evaluation. **AgentOps**
covers the workflow — session lifecycle, live streaming, cancellation, crash-resume, and safety.
These four diagrams show the ops layer wrapped around the LangGraph workflow above.

### 🔬 LLMOps · Observability &amp; Tracing (Langfuse)
...
### 📊 LLMOps · Quality Evaluation &amp; Cost Governance

Quality is scored _after_ the user already has the report (never blocks them): a single LLM call
...
### 🔄 AgentOps · Session Lifecycle &amp; Orchestration

The orchestrator owns the _lifecycle_; the graph owns the _work_. It runs in a background worker
...
### 📡 AgentOps · Live Streaming, Cancellation &amp; Guardrails

The workflow runs in the worker but the browser's SSE connection is held by a _different_ process —
they bridge through Redis pub/sub. A 15s heartbeat beats proxy timeouts; a browser disconnect flips a
Redis cancel flag that every agent checks (so a closed tab stops burning budget). Deterministic
guardrails screen input and sanitize output around the whole run.
...
- **Email:** [vishal25goyal25@gmail.com](mailto:vishal25goyal25@gmail.com)
