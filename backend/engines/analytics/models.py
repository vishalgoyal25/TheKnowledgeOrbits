...
class DailyAggregate(models.Model):
    ...
    articles_read = models.IntegerField(
        default=0,
        help_text="Articles read on this date"
    )
    
    quizzes_taken = models.IntegerField(
        default=0,
        help_text="Quizzes taken on this date"
    )
    
    total_score = models.FloatField(
        default=0.0,
        help_text="Sum of quiz scores"
    )
    ...
    created_at = models.DateTimeField(
        auto_now_add=True,
        help_text="Aggregate creation timestamp"
    )
...
class Insight(models.Model):
    ...
    insight_data = models.JSONField(
        default=dict,
        help_text="Insight details and metadata"
    )
    ...
    expires_at = models.DateTimeField(
        null=True,
        blank=True,
        help_text="When insight becomes stale"
    )
