...
def document():
    ...
    return Document.objects.create(
        title="Test Document", source_type="static", file_path="/test/path.pdf"
    )
...
class TestArticleModel:
    ...
    def test_create_article(self, topic):
        ...
        article = Article.objects.create(
            title="Test Article", content="Test content", topic=topic, word_count=100
        )
    ...
    def test_slug_auto_generated(self, topic):
        ...
        article = Article.objects.create(
            title="My Test Article", content="Content", topic=topic
        )
    ...
    def test_slug_unique_constraint(self, topic):
        ...
        article2 = Article.objects.create(
            title="Same Title", content="Content 2", topic=topic
        )
    ...
    def test_read_time_calculation(self, topic):
        ...
        article = Article.objects.create(
            title="Test", content="Content", topic=topic, word_count=600
        )
    ...
    def test_is_user_owned_property(self, topic, user):
        ...
        article1 = Article.objects.create(
            title="User Article", content="Content", topic=topic, created_by=user
        )
        assert article1.is_user_owned

        # System-owned
        article2 = Article.objects.create(
            title="System Article", content="Content", topic=topic, created_by=None
        )
...
class TestArticleSourceMapModel:
    ...
    def test_create_source_map(self, topic, chunk):
        ...
        source_map = ArticleSourceMap.objects.create(
            article=article, chunk=chunk, relevance_weight=0.8, sequence_order=1
        )
    ...
    def test_source_map_ordering(self, topic, chunk):
        ...
        map2 = ArticleSourceMap.objects.create(
            article=article, chunk=chunk, sequence_order=2
        )
        ...
        map1 = ArticleSourceMap.objects.create(
            article=article, chunk=chunk2, sequence_order=1
        )
...
class TestArticleGenerationJobModel:
    ...
    def test_create_job(self, topic, user):
        ...
        job = ArticleGenerationJob.objects.create(
            topic=topic, requested_by=user, status="pending"
        )
    ...
    def test_job_status_choices(self, topic):
        ...
        job = ArticleGenerationJob.objects.create(topic=topic, status="pending")
