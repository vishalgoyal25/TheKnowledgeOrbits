...
class TopicAdmin(admin.ModelAdmin):
    ...
    list_display = ['name', 'module', 'topic_type', 'difficulty_level', 'order_index', 'is_active', 'created_at']
    list_filter = ['module__subject__program', 'module__subject', 'topic_type', 'difficulty_level', 'is_active', 'created_at']
...
class ChunkTopicMapAdmin(admin.ModelAdmin):
    ...
    list_display = ['topic', 'chunk_preview', 'relevance_score', 'priority', 'auto_mapped', 'created_at']
    ...
    def chunk_preview(self, obj):
        ...
        return obj.chunk.chunk_text[:100] + '...' if len(obj.chunk.chunk_text) > 100 else obj.chunk.chunk_text
...
class ChunkRelationAdmin(admin.ModelAdmin):
    ...
    list_display = ['chunk_1_preview', 'relation_type', 'chunk_2_preview', 'similarity_score', 'created_at']
