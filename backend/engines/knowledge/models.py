...
class Subject(models.Model):
    ...
    order_index = models.IntegerField(
        default=0,
        help_text="Display order within program"
    )
    is_active = models.BooleanField(
        default=True,
        help_text="Is this subject active?"
    )
    created_at = models.DateTimeField(
        auto_now_add=True,
        help_text="Creation timestamp"
...
class Module(models.Model):
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Is this module active?"
    )
    created_at = models.DateTimeField(
        auto_now_add=True,
        help_text="Creation timestamp"
...
class Topic(models.Model):
    ...
    description = models.TextField(
        blank=True,
        help_text="Detailed topic description"
    )
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Is this topic active?"
    )
    created_at = models.DateTimeField(
        auto_now_add=True,
        help_text="Creation timestamp"
...
class Theme(models.Model):
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Is this theme active?"
    )
    created_at = models.DateTimeField(
        auto_now_add=True,
        help_text="Creation timestamp"
