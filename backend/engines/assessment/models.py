...
class Quiz(models.Model):
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Is quiz available for attempts?"
    )
    ...
    created_at = models.DateTimeField(
        auto_now_add=True,
        help_text="Quiz creation timestamp"
    )
...
class Question(models.Model):
    ...
    question_text = models.TextField(
        help_text="The question stem/text"
    )
    ...
    correct_answer = models.CharField(
        max_length=10,
        help_text="Correct option key (A, B, C, or D)"
    )
    ...
    created_at = models.DateTimeField(
        auto_now_add=True,
        help_text="Question creation timestamp"
    )
...
class QuizAttempt(models.Model):
    ...
    started_at = models.DateTimeField(
        auto_now_add=True,
        help_text="When quiz was started"
    )
    
    submitted_at = models.DateTimeField(
        null=True,
        blank=True,
        help_text="When quiz was submitted"
    )
...
class QuestionResponse(models.Model):
    ...
    is_correct = models.BooleanField(
        default=False,
        help_text="Whether answer is correct"
    )
    ...
    marked_for_review = models.BooleanField(
        default=False,
        help_text="Whether user marked this for review"
    )
...
class TopicMastery(models.Model):
    """
    Tracks user's mastery of specific topics over time.
    
    Aggregated from multiple quiz attempts to show learning progress.
    """
    ...
    created_at = models.DateTimeField(
        auto_now_add=True,
        help_text="First attempt timestamp"
    )
    ...
    def __str__(self) -> str:
        return f"{self.user.username} - {self.topic.name}: {self.mastery_score:.1f}%"
    
    def update_mastery(self):
        """Recalculate mastery score based on questions attempted."""
