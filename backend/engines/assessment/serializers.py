...
class QuestionListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Question
        fields = [
            'id', 'question_text', 'question_type', 'statements',
            'options', 'difficulty_level', 'order_index'
        ]
...
class QuestionDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'order_index', 'has_static_sources', 'has_ca_sources'
        ]
...
class QuestionResponseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'question', 'question_detail', 'selected_option',
            'is_correct', 'time_spent', 'marked_for_review',
            'answered_at'
        ]
...
class QuizAttemptSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = QuizAttempt
        fields = [
            'id', 'quiz', 'user', 'status', 'score', 'accuracy',
            'correct_count', 'wrong_count', 'unanswered_count',
            'started_at', 'submitted_at', 'time_spent', 'responses'
        ]
        read_only_fields = [
