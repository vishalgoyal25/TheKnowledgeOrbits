...
class TestQuizListView:
    ...
    def test_list_public_quizzes(self, api_client, topic):
        ...
        Quiz.objects.create(
            title="Public Quiz 1", topic=topic, is_public=True, is_active=True
        )
        Quiz.objects.create(
            title="Public Quiz 2", topic=topic, is_public=True, is_active=True
        )
    ...
    def test_inactive_quizzes_hidden(self, api_client, topic):
        ...
        Quiz.objects.create(
            title="Inactive Quiz", topic=topic, is_public=True, is_active=False
        )
...
class TestQuizGenerateView:
    ...
    def test_generate_quiz_authenticated(
        self, mock_get_generator, authenticated_client, topic
    ):
        ...
        quiz = Quiz.objects.create(
            title="Generated Quiz", topic=topic, question_count=10, is_active=True
        )
    ...
    def test_generate_quiz_invalid_topic(
        self, mock_get_generator, authenticated_client
    ):
...
class TestQuizStartView:
    ...
    def test_start_quiz(self, authenticated_client, topic):
        ...
        quiz = Quiz.objects.create(
            title="Test Quiz", topic=topic, question_count=5, is_active=True
        )
...
class TestQuizSubmitView:
    ...
    def test_submit_quiz_all_correct(self, authenticated_client, topic):
        ...
        data = {
            ...
            "answers": [
                {"question_id": str(q.id), "selected_option": "A"} for q in questions
            ],
        }
