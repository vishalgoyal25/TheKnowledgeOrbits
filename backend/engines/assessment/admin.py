...
class QuizAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'title', 'topic', 'difficulty_level', 'include_ca',
    ...
    fieldsets = (
        ('Basic Info', {
            'fields': ('title', 'topic', 'difficulty_level')
        }),
        ('Configuration', {
...
class QuestionAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'quiz_title', 'order_index', 'question_type',
        'difficulty_level', 'correct_answer', 'has_sources'
    ]
    ...
    fieldsets = (
        ...
        ('Metadata', {
            'fields': ('difficulty_level', 'created_at')
        }),
        ('Sources', {
...
class QuizAttemptAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'user_display', 'quiz', 'status', 'score_display',
        'correct_count', 'started_at', 'time_spent_display'
    ]
...
class QuestionResponseAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'attempt_user', 'question_text_short', 'selected_option',
        'is_correct_display', 'time_spent'
    ]
