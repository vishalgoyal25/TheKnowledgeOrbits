...
class CASource(models.Model):
    ...
    name = models.CharField(
        max_length=200,
        help_text="Source name (e.g., 'The Hindu')"
    )
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Whether to scrape this source"
    )
    ...
    last_error = models.TextField(
        blank=True,
        default='',
        help_text="Last scraping error (if any)"
    )
    article_count = models.IntegerField(
        default=0,
        help_text="Total articles scraped from this source"
    )
...
class CAArticle(models.Model):
    ...
    published_at = models.DateTimeField(
        help_text="Publication timestamp from source"
    )
    ...
    categories = models.JSONField(
        default=list,
        help_text="Article categories/tags"
    )
    ...
    processing_error = models.TextField(
        blank=True,
        default='',
        help_text="Processing error (if failed)"
    )
    ...
    chunk_count = models.IntegerField(
        default=0,
        help_text="Number of chunks generated"
    )
...
class CAChunk(models.Model):
    ...
    chunk_text = models.TextField(
        help_text="Chunk content (~1200 chars)"
    )
    ...
    is_expired = models.BooleanField(
        default=False,
        help_text="Whether this chunk has expired"
    )
