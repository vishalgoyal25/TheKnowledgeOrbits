...
class DocumentAdmin(admin.ModelAdmin):
    list_display = ('title', 'source_type', 'source_edition', 'publication_year', 'created_at')
...
class ChunkAdmin(admin.ModelAdmin):
    list_display = ('__str__', 'document', 'source_type', 'page_number', 'quality_flag', 'confidence_score')
...
class IngestionJobAdmin(admin.ModelAdmin):
    list_display = ('__str__', 'status', 'progress_percentage', 'created_at', 'completed_at')
