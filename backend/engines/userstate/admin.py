...
class UserProgressAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'user_email', 'total_articles_read', 'total_quizzes_taken',
        'current_streak', 'syllabus_coverage_percent', 'updated_at'
    ]
    search_fields = ['user__email']
...
class TopicMasteryAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'user_email', 'topic_name', 'mastery_score',
        'questions_attempted', 'questions_correct', 'updated_at'
    ]
...
class ReadingProgressAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'user_email', 'article_id_short', 'percent_read',
