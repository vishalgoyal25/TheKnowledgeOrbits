...
class TestUserProgressModel:
    ...
    def test_create_progress(self, user):
        ...
        progress = UserProgress.objects.create(
            user=user, total_articles_read=10, total_quizzes_taken=5, current_streak=7
        )
    ...
    def test_syllabus_coverage_validation(self, user):
        ...
        progress = UserProgress.objects.create(
            user=user, syllabus_coverage_percent=50.0
        )
...
class TestTopicMasteryModel:
    ...
    def test_update_mastery_method(self, user, topic):
        ...
        mastery = TopicMastery.objects.create(
            user=user, topic=topic, questions_attempted=10, questions_correct=8
        )
    ...
    def test_mastery_ordering(self, user, topic):
        ...
        topic2 = Topic.objects.create(
            name="Topic 2", module=topic.module, subject=topic.subject
        )
...
class TestBookmarkModel:
    ...
    def test_unique_user_content_constraint(self, user):
        ...
        Bookmark.objects.create(
            user=user, content_type="article", content_id=content_id
        )
    ...
    def test_bookmark_ordering(self, user):
        ...
        b2 = Bookmark.objects.create(
            user=user, content_type="quiz", content_id=uuid.uuid4()
        )
...
class TestReadingProgressModel:
    ...
    def test_create_reading_progress(self, user):
        ...
        progress = ReadingProgress.objects.create(
            user=user, article_id=article_id, percent_read=45.5, last_position=1234
        )
    ...
    def test_percent_read_validation(self, user):
        ...
        progress = ReadingProgress.objects.create(
            user=user, article_id=uuid.uuid4(), percent_read=75.0
        )
