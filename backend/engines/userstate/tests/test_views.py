...
class TestGetProgressView:
    ...
    def test_get_progress_success(self, authenticated_client):
        ...
        # Create some events
        UserEvent.objects.create(user=user, event_type='article_read', event_data={'article_id': str(uuid.uuid4())})
        UserEvent.objects.create(user=user, event_type='quiz_completed', event_data={'quiz_id': str(uuid.uuid4())})
...
class TestBookmarkViews:
    ...
    def test_list_bookmarks(self, authenticated_client):
        ...
        # Create bookmarks
        Bookmark.objects.create(user=user, content_type='article', content_id=uuid.uuid4())
    ...
    def test_remove_bookmark(self, authenticated_client):
        ...
        bookmark = Bookmark.objects.create(user=user, content_type='article', content_id=uuid.uuid4())
...
class TestReadingProgressViews:
    ...
    def test_update_reading_progress(self, authenticated_client):
        ...
        response = client.put(f'/api/v1/userstate/reading-progress/{article_id}/update/', data, format='json')
